...
namespace ProductCompareDotNet.Migrations
{
    public partial class TestChange : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Comment_Product_ProductId", table: "Comments");
            migrationBuilder.DropForeignKey(name: "FK_Comment_ApplicationUser_UserId", table: "Comments");
